// laba4crypto.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main() {
	...
	cout << "dencrypt:" << decrypted << endl;
	
	fileEncrypt << ct;
	fileDencrypt << decrypted;
